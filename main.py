...
def main(args):
    ...
    trainer = pl.Trainer(default_root_dir=os.path.join(args.output_dir, args.run_name), accelerator="gpu", devices=args.gpu_id,
                         max_epochs=args.epochs, log_every_n_steps=50, num_sanity_val_steps=0,
                         precision=args.precision,
                         logger=logger,
                         callbacks=lr_monitor, enable_progress_bar=args.progress_bar)
